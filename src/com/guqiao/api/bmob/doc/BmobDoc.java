package com.guqiao.api.bmob.doc;

import com.guqiao.api.bmob.bson.BSON;
import com.guqiao.api.bmob.bson.BSONObject;
import com.guqiao.api.bmob.restapi.Bmob;

import java.util.Date;

public class BmobDoc {
...
//        requestSms();//发送短信
    ...
    private static void initBmob() {
        Bmob.initBmob("86816123a36411ff23f2b3812d95a138",
                "cb34df0724a77b43e8226d89d7aab228");

        //用到超级权限需要注册该Key
//        Bmob.initMaster("c792ec6d8164c646ea7c39da2b3715b3");
    }
    ...
    private static void requestSms() {
        String res = Bmob.requestSms("18771565822", "您的验证码是：222222, 有效期是10分钟。");
        System.out.println(res);
    }
...
//		BSONObject bson = new BSONObject(result);
    ...
    private static void insert() {
        BSONObject bson = new BSONObject();
        bson.put("student", "fdaf");
        Bmob.insert("test", bson.toString());
    }
