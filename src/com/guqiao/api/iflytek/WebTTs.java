 ...
 * 
 */
 package com.guqiao.api.iflytek;
...
public class WebTTs {
	...
	private static final String APPID = "58646878";
	// 接口密钥（webapi类型应用开通合成服务后，控制台--我的应用---语音合成---相应服务的apikey）
	private static final String API_KEY = "33fd74baefc460b1acab6bcf20da5bbd";
	// 待合成文本
	private static final String TEXT = "请开始你的表演";
